...
This workspace serves as the foundational layer for [SonoPilot](../SonoPilot/README.md), enabling seamless switching between Cartesian position control, impedance control, and hybrid force-position control.
...
Franka_ws/
├── src/
│   ├── franka/                  # 🦾 Franka core libraries
│   ├── franka_ros/              # 🔗 Official Franka ROS packages
│   ├── franka_ros_interface/    # 🎛️ Custom ROS interface layer
│   ├── robotiq_ft_sensor/       # 📊 Force-Torque sensor driver
│   └── franka.rviz              # 🖥️ RViz visualization config
└── README.md
```
