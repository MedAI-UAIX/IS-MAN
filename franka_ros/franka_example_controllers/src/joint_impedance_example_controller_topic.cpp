...
#include <franka_example_controllers/joint_impedance_example_controller_topic.h>
...
bool JointImpedanceExampleControllerTopic::init(hardware_interface::RobotHW* robot_hw,
...
void JointImpedanceExampleControllerTopic::starting(const ros::Time& /*time*/) {
  initial_pose_ = cartesian_pose_handle_->getRobotState().O_T_EE_d;
}

void JointImpedanceExampleControllerTopic::update(const ros::Time& /*time*/,
...
std::array<double, 7> JointImpedanceExampleControllerTopic::saturateTorqueRate(
...
PLUGINLIB_EXPORT_CLASS(franka_example_controllers::JointImpedanceExampleControllerTopic,
