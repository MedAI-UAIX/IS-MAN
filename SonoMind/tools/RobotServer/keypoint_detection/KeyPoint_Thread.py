...
class KeypointDetectionThread(QThread):   #线程类
    ...
    def __init__(self, goal_force=2, save_path='', test_mode='1'):
        ...
        #======= 相机在机器人基底坐标系下的变换 ============
        #------ 相机内参（ros驱动之后可以看到）
        camera_matrix = np.loadtxt("/home/usai/auto_RUSS/R_UI_Agent/keypoint_detection/cameraMatrix.txt", delimiter=",")
        ...
        R_wc = np.loadtxt('/home/usai/auto_RUSS/R_UI_Agent/keypoint_detection/R_wrist2cam_7x11.txt')
        t_wc = np.loadtxt('/home/usai/auto_RUSS/R_UI_Agent/keypoint_detection/t_wrist2cam_7x11.txt')
